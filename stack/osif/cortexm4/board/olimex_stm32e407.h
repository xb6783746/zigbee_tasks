...
#define ZB_SPIx_NSS_SOURCE                GPIO_PinSource10

/* RF Int1 PC.6 (GPIO0 CC1200) */
#define ZB_SPIx_RFINT1_PIN                GPIO_Pin_6
#define ZB_SPIx_RFINT1_GPIO_PORT          GPIOC
#define ZB_SPIx_RFINT1_GPIO_CLK           RCC_AHB1Periph_GPIOC
#define ZB_SPIx_RFINT1_SOURCE             EXTI_PinSource6
#define ZB_SPIx_RFINT1_PORTSOURCE         EXTI_PortSourceGPIOC
#define ZB_SPIx_RFINT1_PUPD               GPIO_PuPd_DOWN

#define ZB_SPIx_RFINT1_LINE               EXTI_Line6
#define ZB_SPIx_RFINT1_IRQHANDLER         EXTI9_5_IRQHandler
#define ZB_SPIx_RFINT1_IRQCHANNEL         EXTI9_5_IRQn

/* RF Int2 PC.7 (GPIO2 CC1200) */
#define ZB_SPIx_RFINT2_PIN                GPIO_Pin_7
#define ZB_SPIx_RFINT2_GPIO_PORT          GPIOC
#define ZB_SPIx_RFINT2_GPIO_CLK           RCC_AHB1Periph_GPIOC
#define ZB_SPIx_RFINT2_SOURCE             GPIO_PinSource7
#define ZB_SPIx_RFINT2_PORTSOURCE         EXTI_PortSourceGPIOC

#define ZB_SPIx_RFINT2_LINE               EXTI_Line7
#define ZB_SPIx_RFINT2_IRQHANDLER         EXTI9_5_IRQHandler
#define ZB_SPIx_RFINT2_IRQCHANNEL         EXTI9_5_IRQn
...
#define ZB_SPIx_RFRES_SOURCE              GPIO_PinSource8
